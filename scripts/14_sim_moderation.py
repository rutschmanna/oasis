...
async def main():
    ...
    db_dir_path = f"/../abyss/home/oasis/oasis-rutschmanna/data/dbs/{n_run}_moderation/reddit-sim_{args.model_name}_subreddit-{args.subreddit}-{args.time_steps}h/"
    ...
    pathlib.Path(f"/../abyss/home/oasis/data/{n_run}_moderation").mkdir(exist_ok=True)
    sim_stats_path = f"/../abyss/home/oasis/data/{n_run}_moderation/sim_metrics.csv"
    try:
