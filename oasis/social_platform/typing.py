...
class ActionType(Enum):
    ...
    UNDO_UPVOTE_POST = "undo_upvote_post"
    DISLIKE_POST = "dislike_post"
    UNDO_DISLIKE_POST = "undo_dislike_post"
    DOWNVOTE_POST = "downvote_post"
    UNDO_DOWNVOTE_POST = "undo_downvote_post"
    FOLLOW = "follow"
    UNFOLLOW = "unfollow"
    MUTE = "mute"
    UNMUTE = "unmute"
    ...
    UNDO_UPVOTE_COMMENT = "undo_upvote_comment"
    DISLIKE_COMMENT = "dislike_comment"
    UNDO_DISLIKE_COMMENT = "undo_dislike_comment"
    DOWNVOTE_COMMENT = "downvote_comment"
    UNDO_DOWNVOTE_COMMENT = "undo_downvote_comment"
